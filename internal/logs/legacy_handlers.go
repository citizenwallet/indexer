...
func NewLegacyService(chainID *big.Int, db *db.DB, comm *ethrequest.Community) *LegacyService {
...
func (s *LegacyService) Get(w http.ResponseWriter, r *http.Request) {
...
func (s *LegacyService) GetNew(w http.ResponseWriter, r *http.Request) {
	// parse contract address from url params
	contractAddr := chi.URLParam(r, "contract_address")
...
func (s *LegacyService) AddSending(w http.ResponseWriter, r *http.Request) {
	// parse contract address from url params
	contractAddr := chi.URLParam(r, "contract_address")
...
func (s *LegacyService) SetStatus(w http.ResponseWriter, r *http.Request) {
	// parse contract address from url params
	contractAddr := chi.URLParam(r, "contract_address")
